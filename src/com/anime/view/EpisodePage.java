...
public class EpisodePage extends JPanel{
    ...
    private void initComponents(){
        ...
        episodeInfoPnl.setBorder(new EmptyBorder(20,30,20,20));
        ...
        reviewTextAreaScroll.setAlignmentX(Component.CENTER_ALIGNMENT);
...
//        reviewTextAreaScroll.getVerticalScrollBar().setPreferredSize(new Dimension(1,Integer.MAX_VALUE));
        reviewTextAreaScroll.setBorder(new EmptyBorder(10, 20, 10, 45));
        ...
        reviewsPanel.setBorder(new EmptyBorder(10, 20, 10, 45));
        reviewsPanel.setPreferredSize(new Dimension(1280, 600));
        reviewsPanel.setMaximumSize(new Dimension(Integer.MAX_VALUE, 720));

        reviewsPanel.add(new JLabel("Leave Comment"));
        ...
        reviewsScrollPane.setMaximumSize(new Dimension(Integer.MAX_VALUE, Integer.MAX_VALUE));
