...
('thistlezhi', 'testpassword', '2006-08-21', 'Malaysia', '2014-03-18'),
...
INSERT INTO series (title, genre, release_year, total_episode_count, status_of_series, series_photo)
VALUES
('One Punch Man', 'Comedy', '2015', '12', 'Complete', '/images/OnePunchMan.jpg'),
('Ouran High School Host Club', 'Comedy, Romance', '2006', '26', 'Complete', '/images/OHSHC.jpg'),
('Demon Slayer: Kimetsu no Yaiba Hashira Training Arc', 'Action', '2024', '8', 'Complete', '/images/DemonSlayerHashiraTraining.jpg'),
('My Hero Academia Season 8', 'Action', '2025', '6', 'On-Going', '/images/MHA8.jpg'),
('Spy x Family Season 3', 'Comedy', '2025', '13', 'On-Going', '/images/SpyXFamily3.jpg'),
('GACHIAKUTA', 'Fantasy', '2025', '24', 'On-Going', '/images/Gachiakuta.jpg'),
('Tougen Anki: Dark Demon of Paradise', 'Fantasy', '2025', '15', 'On-Going', '/images/TougenAnki.jpg'),
('Kaguya-sama: Love Is War', 'Romance', '2019', '12', 'Complete', '/images/KaguyaSamaLoveIsWar.jpg'),
('Paradise Kiss', 'Romance', '2005', '12', 'Complete', '/images/ParadiseKiss.jpg'),
('Given', 'Boys Love', '2019', '11', 'Complete', '/images/Given.jpg'),
('Elfen Lied', 'Action', '2004', '13', 'Complete', '/images/ElfenLied.jpg'); --
UNLOCK TABLES;
...
(2, 'Beware the Physical Exam!', '2006-04-18', 'Its physical exam time at Ouran Academy which could spell trouble for someone who spends her days in disguise. Meanwhile, Tamaki launches the Host Club on diversionary tactics, and Kyoya has a backup plan.', 4000, 23),
(2, 'Attack of the Lady Manager!', '2006-04-25', 'Tamaki is jealous of the relationship between the twins and Haruhi. Meanwhile, a young woman obsessed with dating sims declares herself the Host Clubs new manager and her first order of business is to give all of the Hosts a dark side.', 4600, 23),
(2, 'The Twins Fight!', '2006-05-02', 'Haruhi divulges her secret for tellinag Hikaru and Kaoru apart, as the rivalry between the twins begins to spiral out of control and is causing a dip in the Clubs profits.', 5200, 23),
...
(2, 'A Day in the Life of the Fujioka Family', '2006-06-06', 'Tamaki investigates what Haruhis aggregate commoner dwelling is like. He finds there is plenty of room for trouble.', 8452, 23),

-- MOMOTARO (Series 7)
(7, 'Onis Blood', '2025-07-11', 'Shiki Ichinoses life is turned upside down when hes attacked by a mysterious stranger and learns a shocking secret about his own heritage.', 8452, 24),
...
(7, 'Children of Kishin', '2025-09-12', 'As Shikis desperate battle rages on, the scene shifts to the Momotaro Agency Headquarters, where a new operative begins her assignment.', 0, 24),
...
(7, 'Personal Rule', '2025-10-10', 'The fallout from the festival incident is quickly detected by the Momotaros wide-reaching surveillance network, prompting an immediate response.', 0, 24),
...
(8, 'Miyuki Shirogane Still Hasnt Done It / Kaguya Wants to Be Figured Out / Kaguya Wants to Walk', '2019-01-26', 'Chika discovers an unwholesome magazine with a scandalous survey. Kaguyas coy response to the surveys main question sends Shiroganes mind reeling, as he tries to figure out if shes bluffing or not.', 6950, 24),
(8, 'Kaguya Wants Affection / The Student Council Wants It to Be Said / Kaguya Wants Him to Send It / Miyuki Shirogane Wants to Talk', '2019-02-02', 'Chika suggests the student council should try on costumes. Kaguya is reluctant, but when she puts on a pair of cat ears, Shiroganes reaction is not what she expected. A new battle begins over a forgotten smartphone.', 9010, 24),
(8, 'Kaguya Wants to Handle It / Miyuki Shirogane Wants to Show Off / Kaguya Wants to Be Covered', '2019-02-09', 'Shirogane is brilliant, but hes hopelessly unathletic. With an upcoming volleyball class threatening to destroy his perfect image, he secretly begs Chika to train him, leading to a disastrous and hilarious week of practice.', 8830, 24),
(8, 'Yu Ishigami Wants to Live / Chika Fujiwara Wants to Test You / Kaguya Wants to Be Noticed', '2019-02-16', 'The student councils reclusive treasurer, Yu Ishigami, finally makes an appearance. Hes come to Shirogane to resign, claiming that Kaguya is trying to murder him.', 9250, 24),
(8, 'Miyuki Shirogane Wants to Work / Kaguya Wants Him to Join In / Kaguya Wants to Control It', '2019-02-23', 'Shiroganes love expert status is put to the test again when Kashiwagis boyfriend returns for more advice. Kaguya, listening in, is horrified by the nonsensical strategies Shirogane proposes.', 7880, 24),
(8, 'Kaguya Wants Her to Say It / Miyuki Shirogane Cant Lose / Yu Ishigami Closes His Eyes', '2019-03-02', 'Term-end exams are here, and the war moves to the academic battlefield. Kaguya and Shirogane, both proud geniuses, engage in a ruthless psychological battle to see who will claim the #1 spot in the school rankings.', 9590, 24),
...
(8, 'Kaguya Wont Forgive / Kaguya Wants to Forgive / Miyuki Shirogane Wants to Go Somewhere', '2019-03-16', 'After a fight over the sick visit incident, a cold war develops between Kaguya and Shirogane. Both are too proud to apologize, so they secretly seek advice from Kashiwagi and Ishigami on how to make the other person apologize.', 7290, 24),
(8, 'Ai Hayasaka Wants to Get Soaked / Chika Fujiwara Really Wants to Eat It / Miyuki Shirogane Wants to See You / I Cant Hear the Fireworks, Part 1', '2019-03-23', 'Summer vacation has begun, and Kaguya is depressed, having no excuse to see Shirogane. She eagerly awaits the one event they planned: the summer fireworks festival. However, her familys strict rules threaten to ruin the night.', 9110, 24),
...
(11, 'The House (Reception)', '2004-08-21', 'Kouta, Yuka, and Nyu take refuge in an abandoned restaurant belonging to Koutas family. Mayu, a young girl running away from her troubled home, joins their group.', 16800, 24),
...
(11, 'The Moment of Truth (Confrontation)', '2004-09-04', 'Nana and Lucy meet, leading to a vicious and highly destructive vector battle. Nanas loyalty is tested by the facilitys ruthless orders.', 18000, 24),
...
(11, 'A Memory (Reminiscence)', '2004-09-18', 'Kouta attempts to find the key to Lucys past, leading him to a painful memory about the death of his family, which he had suppressed for years.', 18550, 24),
...
(11, 'The Secret Chamber (Complication)', '2004-10-02', 'The facilitys true purpose and the dark conspiracy behind the vectors are brought to light. Kouta and Yuka confront their feelings for each other amidst the chaos.', 19800, 24),
...
-- GIVEN (Series 4)
(10, 'He Is Not My Kind of Person', '2019-07-11', 'High schooler Ritsuka Uenoyama is bored with everything—especially his passion for music—until he meets Mafuyu Sato, a quiet boy holding a broken guitar.', 12500, 24),
(10, 'Like Someone Is Not There', '2019-07-18', 'Uenoyama reluctantly agrees to fix Mafuyus guitar and teach him chords. He finds himself drawn to Mafuyus voice, which holds a powerful emotional depth.', 13150, 24),
(10, 'Somebody Else', '2019-07-25', 'Uenoyama and the band members try to figure out how to incorporate Mafuyu into the group. Haruki, the bassist, reveals a crush on the drummer, Akihiko.', 13700, 24),
(10, 'Loving Someone Is Not a Dream', '2019-08-01', 'Mafuyus silence and lack of musical experience frustrate Uenoyama. A revelation about Mafuyus past and the broken guitar sheds light on his quiet demeanor.', 14200, 24),
(10, 'The Time Not Spent With You', '2019-08-08', 'Haruki confronts Akihiko about his confusing behavior. Uenoyama struggles to write a song for Mafuyus voice, feeling pressure from his own unacknowledged emotions.', 14850, 24),
(10, 'Empty World', '2019-08-15', 'The band prepares for their live show. Mafuyu finally tries singing, and his raw, emotional performance shocks Uenoyama and the audience.', 16000, 24),
(10, 'A Story of the Past', '2019-08-22', 'Flashbacks explore the relationship between Mafuyu and his late boyfriend, Yuki, revealing the tragic context behind Mafuyus emotional repression and his powerful voice.', 15550, 24),
(10, 'I Was There', '2019-08-29', 'Uenoyama finally understands the depth of Mafuyus grief. He realizes his feelings for Mafuyu are intertwined with the song he wrote and the need to help Mafuyu move forward.', 16400, 24),
(10, 'A Line in the Sand', '2019-09-05', 'After the concert, Mafuyu begins to process his feelings. Uenoyama and Mafuyu have an emotional encounter backstage, leading to a major turning point in their relationship.', 17200, 24),
(10, 'The World Change', '2019-09-12', 'The band deals with the aftermath of the successful live show. Uenoyama and Mafuyu navigate their new feelings, forcing the band to face their uncertain future.', 17950, 24),
(10, 'The Song of a Snowfall', '2019-09-19', 'Mafuyu and Uenoyama try to balance their relationship with their musical commitments. The entire band is focused on writing new music, but the creative pressure mounts.', 18500, 24);
UNLOCK TABLES;
...
--
CREATE TABLE `actors` (
    `actors_id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
(1, 4, 'Cant wait for the next episode!','2025-11-23'),
...
(5, 2, 'The ending shocked me! Cant believe that happened.','2025-11-25'),
...
INSERT INTO favoriteSeries (user_id, series_id, added_date)
VALUES
(1, 1, '2025-11-22'),
(1, 2, '2025-11-22'),
(1, 3, '2025-11-22'),
